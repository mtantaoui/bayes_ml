...
PyObject *py_copy_matrix(PyObject *self, PyObject *args)
{
    ...
    py_matrix_out = (PyArrayObject *)PyArray_SimpleNew(2, PyArray_DIMS(py_matrix_in), NPY_DOUBLE);
    // py_matrix_out = (PyArrayObject *)PyArray_Zeros(PyArray_NDIM(py_matrix_in), PyArray_DIMS(py_matrix_in),
